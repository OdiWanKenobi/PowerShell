<#
    ...
    .AUTHOR
        Alex Labrosse
    .DESCRIPTION
        Using the Forms API through PowerShell, creates a pop-up windows that asks the user whether they have hydrated in the last hour.
        Records the reponse, and add the date, time, and response to the .TXT log file.
        Check "C:\Output\" for the aforementioned .TXT file.
#>
